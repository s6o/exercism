public class Authenticator
{
    ...
    {
        {"Bertrand", new Identity { Email = "bert@ex.ism", FacialFeatures = new FacialFeatures { EyeColor = "blue", PhiltrumWidth = 0.8m }, NameAndAddress = ["Bertrand", "Paris", "France"] }},
        {"Anders", new Identity { Email = "anders@ex.ism", FacialFeatures = new FacialFeatures { EyeColor = "brown", PhiltrumWidth = 0.85m }, NameAndAddress = ["Anders", "Redmond", "USA"] }},
    };
}
