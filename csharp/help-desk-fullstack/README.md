...
The Blazor implementation also uses [bUnit](https://bunit.dev/) for component (unit) tests and provides
[Playwright](https://playwright.dev/dotnet/) examples for End-2-End tests.
