...
let ``List - eggs and peanuts`` () =
    list 3
    |> should equal [ Allergen.Eggs; Allergen.Peanuts ]

[<Fact>]
let ``List - more than eggs but not peanuts`` () =
    list 5
    |> should equal [ Allergen.Eggs; Allergen.Shellfish ]
